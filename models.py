"""Selected original model definitions, extracted without changing their bodies.

DoubleConv and UNet: notebooks/model_comparsion.ipynb, cell 0.
RES_Block and WC_Block: notebooks/BU_net/model_modified.ipynb, cell 0.
These historical blocks intentionally preserve their spatial-size behavior.
See docs/reproduction-notes.md before combining them into a full architecture.
"""
import torch
